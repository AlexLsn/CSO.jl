"""
    CR_gammaReg_inv(topredict::String, varnames::Vector{Symbol}, train::DataFrame, test::DataFrame, nbVar::Int64)

    Tests all possible set of variables (limited to `nbVar` variables) fitting a gamma regression (inverse link).
...
- `nbVar::Int64`: The number of variables to include in the research.
"""
function CR_gammaReg_inv(topredict::String, varnames::Vector{Symbol}, train::DataFrame, test::DataFrame, nbVar::Int64)
