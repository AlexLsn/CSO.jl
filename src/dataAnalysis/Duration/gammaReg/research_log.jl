"""
    CR_gammaReg_log(topredict::String, varnames::Vector{Symbol}, train::DataFrame, test::DataFrame)

Tests and ranks (RMSD) all possible set of variables fitting a gamma regression (log link).
...
"""
function CR_gammaReg_log(topredict::String, varnames::Vector{Symbol}, train::DataFrame, test::DataFrame)
...
"""
    stepRMSD_gammaReg_log(topredict::String, varnames::Vector{Symbol}, initial_list::Vector{Symbol}, train::DataFrame, test::DataFrame, verbose::Bool=true)
